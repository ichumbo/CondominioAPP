...
const PATHS: Record<IconName, ReactElement> = {
  ...
  scale: (
    <>
      ...
      <path d="m6 7 3 7H3l3-7zM18 7l3 7h-6l3-7z" />
      <path d="M7 4h10" />
    </>
  ),
  truck: (
  ...
  wallet: (
    <>
      <path d="M19 7V5a2 2 0 0 0-2-2H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v9a1 1 0 0 1-1 1H4a2 2 0 0 1-2-2V5" />
  ...
  key: (
    <>
      ...
      <path d="m10.5 12.5 9-9M16 6l3 3M19 3l3 3" />
    </>
  ),
...
export const ICON_KEYS = new Set<string>(Object.keys(PATHS));
